...
const Footer = () => {
  // Fake data
  const companyInfo = {
    name: 'GeekCode Digital',
    description: 'GeekCode Digital is a premier web development agency specializing in custom websites, mobile applications, and digital solutions. We transform ideas into powerful digital experiences.',
    logo: '/assets/logo.png',
    year: new Date().getFullYear(),
  };

  const socialLinks = [
    { icon: <FaFacebook size={20} />, url: 'https://facebook.com/GeekCodedigital', label: 'Facebook' },
    { icon: <FaLinkedin size={20} />, url: 'https://linkedin.com/company/GeekCodedigital', label: 'LinkedIn' },
    { icon: <FaInstagram size={20} />, url: 'https://instagram.com/GeekCodedigital', label: 'Instagram' },
  ...
  const contactInfo = [
    ...
    { icon: <FiMail className="text-main mt-0.5 mr-2 h-5 w-5" />, text: 'hello@GeekCodedigital.com', isEmail: true },
  ];
